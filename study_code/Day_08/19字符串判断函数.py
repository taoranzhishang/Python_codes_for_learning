...
print("Hello World".istitle())  # 仅元素首字母大写，其他字母小写返回true
print("123".isdecimal())  # 判断纯10进制数
print("0xa1".isdecimal())  # 不能说明其它进制，其它非10进制符号返回False
print("0xa1".isdigit())  # 有其它字符返回false，不能说明其它进制
